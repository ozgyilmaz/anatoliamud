...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "prac_old",       do_practice,	POS_SLEEPING,    ML, LOG_NORMAL, 1, CMD_KEEP_HIDE },
...
void substitute_alias(DESCRIPTOR_DATA *d, char *argument)
{
    ...
    for (alias = 0; alias < ana_config.max_alias; alias++)
    {
...
void do_alias(CHAR_DATA *ch, char *argument)
{
	...
	for (pos = 0; pos < ana_config.max_alias; pos++)
	{
